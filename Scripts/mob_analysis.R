# ==============================================================================
# MOB (Methanotrophic Bacteria) Analysis Script
# ==============================================================================
# Purpose: 
#   1. Analyze MOB distribution and relative abundance
#   2. Identify dominant/rare MOB groups and key species by site
# 
# Input: final-table-with-ranks.tsv (QIIME2 feature table with taxonomy)
# Output: 
#   - MOB genus-level stacked bar plot
